...
export class BranchDropdown extends React.Component<IBranchDropdownProps> {
  ...
  public render() {
    ...
    if (checkoutProgress) {
      ...
      description = __DARWIN__ ? '切换分支' : '切换分支'
      ...
      tooltip = `切换到 ${checkoutProgress.targetBranch}`
      ...
      canOpen = false
      disabled = true
      tooltip = `重置 ${conflictState.targetBranch}`
    }
